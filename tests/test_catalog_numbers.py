...
def test_invalid_century_indicator():
    ...
    assert catalog.parse_catalog_number("3601-1") is None  # Century indicator should be 2
    assert catalog.parse_catalog_number("1601-1") is None  # Century indicator should be 2
